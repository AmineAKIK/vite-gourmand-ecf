...
// Rien d'autre dans l'application ne calcule de prix directement.
...
class PricingService
{
    ...
    public static function computeOrderTotal(
        ...
        $seuilReduction   = reductionSeuilMontant();
        $tauxReduction    = reductionTauxPourcentage();
        ...
        $prixLivraison = calculPrixLivraisonAdresse($adresse, $ville, $codePostal);
    ...
    {
        $regime = siteConfigValue('regime_tva', 'assujetti');
